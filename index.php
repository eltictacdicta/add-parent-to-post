...
namespace AddHierarchyParentToPost
{
  ...
  class PluginClass extends \Puvox\wp_plugin
  {
    ...
    public $initial_user_options;
    public $initial_static_options;
    public $static_settings;
    public $network_managed_is_selected;
    public $opts;
    public $notes_enabled;
    public $is_pro;
    public $is_pro_legal;
    public $addons_dir;
    public $network_wide_active;
    public $settingsPHP_page_dynamic;
    public $plugin_page_url;
    public $plugin_files;
    public $translation_phrases;
    public $is_in_customizer;
    public $myplugin_class;
    public $addon_namepart;
    public $pro_file_part;
